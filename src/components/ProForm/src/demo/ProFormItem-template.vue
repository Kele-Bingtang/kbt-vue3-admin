<template>
  <Tinymce
    ...
    :model-value="getFormProp(model, column.formItem.prop)"
    @update:model-value="v => setFormProp(model, column.formItem.prop, v)"
  ...
  <component
    ...
    v-bind="{
      ...handleFormProps,
      ...placeholder,
      scope: { form: model, data: getFormProp(model, column.formItem.prop), enumData: columnEnum },
      clearable,
    }"
    :model-value="getFormProp(model, column.formItem.prop, column.attrs.valueFormat)"
    @update:model-value="(v: any) => setFormProp(model, column.formItem.prop, v)"
...
const isDisabled = () => {
  if (typeof props.column.attrs.isDisabled === "function") return props.column.attrs.isDisabled(unref(model));
